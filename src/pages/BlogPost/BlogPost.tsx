        ...
        <div className="flex gap-[30px] lg:gap-12">
          <div className="BlogPost">
            ...
            <p className="BlogPost__text">
              ...
              работал с приложениями, тем более на таком гео, как Индия, где
              цены за клик минимальные.
            </p>
            ...
            <ol className="BlogPost__ordered-list">
              ...
              <li className="BlogPost__ordered-list-item">
                Доверять своему аффилейту, спрашивать по любому поводу и
                говорить о любых неприятностях.
              </li>
            </ol>
            ...
            <div className="BlogPost__tiles">
              ...
              <div className="BlogPost__tile BlogPost__tile--half">
                ...
                <p className="BlogPost__tile-text">
                  ...
                  <span className="BlogPost__text--accent">27-36$</span> (Если
                  уже лили или льете)
                </p>
              </div>
              <div className="BlogPost__tile BlogPost__tile--half">
                ...
                <p className="BlogPost__tile-text">
                  sms2reg ={" "}
                  <span className="BlogPost__text--accent">1к2/3</span>
                  <br />
            ...
            <p className="BlogPost__quote">
              ...
              <span className="BlogPost__text--accent">5.960$</span>
              <br />
              Итоговый ROI:{" "}
              <span className="BlogPost__text--accent">329.65 %</span>
            </p>
            <p className="BlogPost__text">
              При том, что аккаунт инсты это разовая затрата + по индии спендит
              от 50-80$ в день с одного ака FB, банят их раз в 2-3 дня. За весь
            ...
            <ol className="BlogPost__ordered-list">
              ...
              <li className="BlogPost__ordered-list-item">
                ...
                большинство людей в Индии не образованны и не знают родного
                языка. 95% населения общается на ломанном английском.
              </li>
            </ol>
            <p className="BlogPost__text">
            ...
            <p className="BlogPost__text">
              Если вы не захотели покупать готовый профиль, то все, что будет
              ниже поможет в его создании.
            </p>
            <p className="BlogPost__text-highlighted">
              Ваша задача составить историю о своем персонаже: кто вы, чем
              занимаетесь, чем зарабатываете, рассказать как круто вы отдыхаете
              в жарких странах и показать как много денег получаете.
            </p>
            <p className="BlogPost__quote">
              Очень важный момент! НИ В КОЕМ СЛУЧАЕ, НЕ КОПИРУЙТЕ ЧУЖОЙ
              ИНСТАГРАМ ПРОФИЛЬ!!! Если вы это сделаете 99%, что ваш инстаграм
              заблокируют или же 50% пришедшего трафика скажет, что вы фейк.
            </p>
            <p className="BlogPost__text">
            ...
            <p className="BlogPost__text">
              ...
              это не то гео, где люди кидают глаз на профиль, но всё же
              требуется уделить этому серьезное внимание, т.к ваш конверт
              зависит от него.
            </p>
            ...
            <p className="BlogPost__text">
              Подойдите к выборке креатива с максимальным вниманием и не
              копируйте примеры, которые мы предоставляем в кейсе - это всего
              лишь примеры, которые должны направить вас в нужное русло мыслей!
            </p>
            <p className="BlogPost__text">
            ...
            <p className="BlogPost__text">
              Ваша цель сделать простое крео, чтобы особо не отпугивать
              аудиторию еще на просмотре рекламы в надежде докрутить лида уже на
              моменте обработки.
            </p>
            ...
            <p className="BlogPost__text">
              ...
              закрывать лиды на 50$ редепами, да-да, такие бывают в Индии.
              Сейчас средний деп по всему потоку составил - 37$, что повлекло за
              собой ап ставки и снижение холда.
            </p>
            <p className="BlogPost__text">
